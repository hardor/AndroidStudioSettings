...
data class RanobeHubBook(
    ...
    @SerializedName("id") val id: Int? = null, @SerializedName("name_rus") val nameRus: String? = null, @SerializedName(
        "name_eng") val nameEng: String? = null, @SerializedName("description") val description: String? = null, @SerializedName(
        "chapters") val chapters: Int? = null, @SerializedName("rating") val rating: Int? = null, @SerializedName(
        "changed_at") val changedAt: String? = null, @SerializedName("url") val url: String? = null, @SerializedName(
        "image") val image: String? = null
