        ...
        val MIGRATION_2_3: Migration = object : Migration(2, 3) {
            override fun migrate(database: SupportSQLiteDatabase) {
                ...
                try {
                    ...
                    database.execSQL("INSERT INTO ranobe2 (Url,Id,EngTitle,Title,Image,ReadyDate,Lang,Description,AdditionalInfo,RanobeSite,ChapterCount,LastReadChapter,IsFavorite,IsFavoriteInWeb,Rating,Status) SELECT Url,Id,EngTitle,Title,Image,ReadyDate,Lang,Description,AdditionalInfo,RanobeSite,ChapterCount,LastReadChapter,IsFavorite,IsFavoriteInWeb,Rating,Status FROM ranobe;")
